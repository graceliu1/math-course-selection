...
<html>
<head>
    <title>DHS Math Course Selection Result</title>
    <meta charset="utf-8">
	...
	<style>
        .jumbotron-header {
            ...
            rgba(0, 0, 0, 0.4),
            rgba(0, 0, 0, 0.4)
            ), url("Images/green_wallpaper2.jpg");
        ...
        .card-style1 {
            background-color: #FFFEF2; /*champagne color*/
        }
        .card-style2 {
...
<body>
	...
	<?php $filename = 'math_selection_action_page.php'?>
	<?php include 'header.php';?>

    <div class = "jumbotron text-center jumbotron-header"> 
        <br><br> 
        <h1 style = "font-family: 'Crimson Text', serif;">Dublin High School</h1>
        <h1 style = "font-size: 450%">YOUR PATHWAY</h1>
		<br>
		<a href="index.php" class="btn btn-lg btn-outline-light">Home</a>
		<a href="guide.php" class="btn btn-lg btn-outline-light">Guide</a>
       <!--<button class = "btn btn-lg btn-outline-light !important " > <a class = "btn-link" href="index.php">Home</a></button>-->
	</div>
	...
	<div class = "card-deck">
		...
		<div class = "card card-style1">
			<div class = "card-header">
				<br>
				<h2 class = "container">CURRENT INFORMATION:</h2>
			</div>
			<div class=  "container">
				<div class = "card-body"> 
					<!-----------------------START OF PHP------------------------->
